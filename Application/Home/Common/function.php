    ...
    if (false != ($handle = opendir ( $dir ))) {
        ...
        while ( false !== ($file = readdir ( $handle )) ) {
            if ($file != "." && $file != ".." && strpos($file,".") && in_array(substr($file,-3), $exts)) {
                $fileArray[$i] = __ROOT__."/".$dir.$prefix.$file;
                if($i==100){
                    break;
                }
                $i++;
